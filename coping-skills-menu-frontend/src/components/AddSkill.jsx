...
import StudentService from '../services/SkillService';
                              ...
                              <form>  
                                  <div className="form-group">
                                   ...
                                   <div className="form-group">
                                      ...
                                      <input placeholder="strategy" name="name" className="form-control"
                                         value={this.state.strategy} onChange={this.strategyHandler} />
                                   </div>   
                                   <div className="form-group">
                                      <label>Repeat: </label>
                                      <input placeholder="How long/how many times" name="grade" className="form-control"
                                         value={this.state.reps} onChange={this.gradeHandler} />
                                   </div>   
